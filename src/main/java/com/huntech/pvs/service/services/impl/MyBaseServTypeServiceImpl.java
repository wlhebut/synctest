...
public class MyBaseServTypeServiceImpl implements MyBaseServTypeService {
    ...
    @Override
    public List<MyServViews> selectAllServsByOpenid(MyServsRequest myServsRequest) {
        Map<String,Object> params=new HashMap<>();
        String openid = myServsRequest.getOpenid();
        params.put("openid",openid);
        params.put("state",1);
        List<MyServViews> myServViews = myBaseservTypeMapper.selectMyServViews(params);
        return myServViews;
    }
