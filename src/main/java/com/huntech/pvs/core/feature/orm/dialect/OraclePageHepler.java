package com.huntech.pvs.core.feature.orm.dialect;
...
public class OraclePageHepler {
    ...
    public static String getLimitString(String querySelect, int offset, int limit) {
        ...
        pagingSelect.append("select * from ( select t.*, rownum as rn from ( ");

        pagingSelect.append(querySelect);

        pagingSelect.append(" ) t  where rownum<= "+(offset + limit) +") where rn > " + offset );
